...
#ifndef DEFI_CHAINPARAMS_H
#define DEFI_CHAINPARAMS_H
 ...
 * DeFi Blockchain system. There are three: the main network on which people trade goods
...
const auto SMART_CONTRACT_DFIP_XXXX = "DFIPXXXX";
