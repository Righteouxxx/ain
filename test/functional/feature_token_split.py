...
class TokenSplitTest(DefiTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            ['-txnotokens=0', '-amkheight=1', '-bayfrontheight=1', '-eunosheight=1', '-fortcanningheight=1', '-fortcanningmuseumheight=1', '-fortcanninghillheight=1', '-greatworldheight=150', '-subsidytest=1']]
