...
class GovsetTest (DefiTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Unrecognised key argument provided, valid keys are:", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/token/5/unrecognised':'true'}})
        ...
        assert_raises_rpc_error(-5, 'payback_dfi value must be either "true" or "false"', self.nodes[0].setgov, {"ATTRIBUTES":{'v0/token/5/payback_dfi':'not_a_number'}})
        assert_raises_rpc_error(-5, 'payback_dfi value must be either "true" or "false"', self.nodes[0].setgov, {"ATTRIBUTES":{'v0/token/5/payback_dfi':'unrecognised'}})
        assert_raises_rpc_error(-5, 'futureswap value must be either "true" or "false"', self.nodes[0].setgov, {"ATTRIBUTES":{'v0/token/5/futureswap':'unrecognised'}})
        ...
        assert_raises_rpc_error(-5, "Active key value must be either \"true\" or \"false\"", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfip2201/active':'not_a_bool'}})
        ...
        assert_raises_rpc_error(-5, "Identifier must be a positive integer", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfipxxxx/period_blocks': '-1'}})
        assert_raises_rpc_error(-5, "Identifier must be a positive integer", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfipxxxx/period_blocks': 'not_a_number'}})
        assert_raises_rpc_error(-5, "Identifier must be a positive integer", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfipxxxx/period_blocks': '1.1'}})
        assert_raises_rpc_error(-5, "Percentage exceeds 100%", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfip2201/premium': '1.00000001'}})
        assert_raises_rpc_error(-5, "Unrecognised key argument provided", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfip2201/not_a_param': '1.00000001'}})
